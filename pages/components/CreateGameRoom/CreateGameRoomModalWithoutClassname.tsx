      ...
      {showPickGameModal ? (
        ...
        <form className="flex flex-col gap-[24px] py-10 px-[55px] mix-h-[500px] mx-auto">
          <div className="">
            ...
            <input
              className="text-base py-[5px] px-[9px] border-[#1E1F22] border rounded-[10px] bg-[#1E1F22]"
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex gap-[5px] mt-[7px]">
                    <label className="bg-[#1E1F22] w-[34px] aspect-square rounded-[10px] flex items-center justify-center">
                      1
                    </label>
                    <label className="bg-[#1E1F22] w-[34px] aspect-square rounded-[10px] flex items-center justify-center">
                      1
