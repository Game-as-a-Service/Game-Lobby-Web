...
describe("Badge", () => {
    ...
    it("renders dot", () => {
        ...
        const element = container.querySelector(".badge-dot");
        expect(element).toBeInTheDocument();
    });
    ...
    //     const { container } = render(<Badge count={<FaBeer />} />);
    ...
    it("should show zero when showZero is true and count is 0", () => {
        ...
        const element = container.querySelector(".badge-count");
    ...
    it("should not show badge when showZero is false and count is zero", () => {
        ...
        const element = container.querySelector(".badge-hidden");
        expect(element).toBeInTheDocument();
    });
